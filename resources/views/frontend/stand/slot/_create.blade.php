        ...
        <form id="form-file" enctype="multipart/form-data">
            <div class="col-lg-12" id="form-item">
                ...
                <div class="form-group mt-20 ">
                    ...
                    <input type='text' name="food_name" id="food_name" placeholder="Cth. Nasi Goreng" required class="form-control" />
                </div>
                <div class="form-group mt-20 ">
                ...
                <div class="form-group mt-20 ">
                    ...
                    <input type='number' min='0'  name="stock" id="stock" required class="form-control" />
                </div>
                <div class="form-group mt-20 ">
                    <label class="control-label mb-10">{!! label('Harga Jual', 'selling price') !!}</label>
                    <input type='text' name="selling_price_client" id="selling_price_client" required class="form-control format-price" />
                </div>
                <div class="form-group mt-20 ">
