<!-- Row -->
<div class="row">
        <div id="stand-" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h4>Hasil Pencarian "{{\Input::get('search')}}"</h4>
        </div>
                        ...
                        <div class="panel-body pa-5">
                            <article class="col-item">
                                ...
                                <div class="pt-5">
                                    ...
                                    <p class="text-success">Stok {{format_quantity($item->stock)}}</p>
