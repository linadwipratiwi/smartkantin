                        ...
                        <div class="panel-heading" style="color: black">
                            <div class="pull-left">
                                ...
                                <div class="pull-left user-detail-wrap">
                                    ...
                                    @if ($item->stock < $cart['quantity']) <p class="text-danger">Stok habis. Tapi bisa digunakan untuk transaksi <i>preorder</i></p>
                                        @endif
                                </div>
                            </div>
...
{{-- modal --}}
<div class="row">
    <div class="modal fade order-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg" style="width:90% !important" id="modal-preorder">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
