                        ...
                        <div class="form-wrap">
                            <form method="post" action="{{url('vending-machine')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="client_id" class="form-control" id="client-id-vm">
                                    </select>
                                </div>
                                
                                <div class="form-group">
                                    <label class="control-label mb-10 text-left">{!! label('baris', 'digunakan untuk generate baris slot') !!} </label>
                                    <input type="number" min="1" name="slot_rows" placeholder="misl. 9" class="form-control" id="baris" value="">
                                </div>
                                <div class="form-group">
                                    <label class="control-label mb-10 text-left">{!! label('kolom', 'digunakan untuk generate kolom slot') !!} </label>
                                    <input type="number" min="1" name="slot_column" placeholder="misl. 4" class="form-control" id="kolom" value="">
                                </div>
                                
                                <div class="form-group">
                                    <label class="control-label mb-10 text-left">{!! label('Versi Firmware', 'Firmware') !!} </label>
                                    <select name="version_firmware_id" id="versi-firmware" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="version_ui_id" id="versi-ui" class="form-control">
...
@section('scripts')
<script>
    initItemSelect2('#client-id-vm', '{{url("api/v1/vending-machine/clients")}}')
    initFormatNumber();
