    <div class="modal fade category-modal-form" id="category-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    ...
    function store() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                populateOption('#category-id', res);
                $("#category-modal").removeClass("in");
