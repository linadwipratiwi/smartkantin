    <div class="modal fade vendor-modal-form" id="vendor-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-lg" id="modal-detail">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h5 class="modal-title" id="myLargeModalLabel">Create New Vendor</h5>
                </div>
                <form method="post" id="form-vendor">
    ...
    <script>
    function store() {
        var data = $( '#form-vendor' ).serialize();
        $.ajax({
            ...
            success: function(res) {
                ...
                populateOption('#vendor-id', res);
                $("#vendor-modal").removeClass("in");
