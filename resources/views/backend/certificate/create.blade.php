                        ...
                        <div class="form-wrap">
                            <form method="post" action="{{url('certificate')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class='input-group' id='date-start'>
                                                <input type='text' name="date_start" value="{{date('Y-m-d H:i:s')}}" class="form-control" />
                                        ...
                                        <div class="col-md-3">
                                            <div class='input-group' id='date-end'>
                                                <input type='text' name="date_end" value="{{date('Y-m-d H:i:s')}}" class="form-control" />
                                                <span class="input-group-addon">
                                                    <span class="fa fa-calendar"></span>
                                                </span>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="publisher" class="form-control" id="" value="">
                                </div>
                                <div class="form-group">
