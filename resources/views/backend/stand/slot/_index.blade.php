<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button class="btn btn-info btn-sm btn-lable-wrap left-label pull-right" onclick="showDetail('{{url("stand/".$vending_machine->id."/slot/create")}}')"> <span class="btn-label"><i class="fa fa-plus"></i> </span><span class="btn-text">Buat baru</span></button>
        </div>
        <div class="col-lg-12">
                        ...
                        <table class="table color-table info-table">
                            ...
                            @foreach($vending_machine->slots as $i => $slot)
                                <tr id="tr-slot-{{$slot->id}}">
                                    <td class="">{{++$i}}</td>
                                    <td>
                                        <a  onclick="showDetail('{{url("stand/".$vending_machine->id."/slot/".$slot->id."/edit")}}')"data-toggle="tooltip" data-original-title="Edit">
                                            <button class="btn btn-default btn-icon-anim btn-square btn-sm"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a onclick="secureDelete('{{url('stand/".$vending_machine->id."/slot/'.$slot->id)}}', '#tr-slot-{{$slot->id}}')" data-toggle="tooltip" data-original-title="Delete"> 
