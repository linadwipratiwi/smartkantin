                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="dt-buttons">
                            <a class="dt-button buttons-copy buttons-html5" tabindex="0" aria-controls="example" href="{{url('stand/create')}}"><i class="fa fa-plus"></i> <span>Buat baru</span></a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="tr-{{$vending_machine->id}}">
                                            ...
                                            <td>
                                                ...
                                                <a onclick="secureDelete('{{url('stand/'.$vending_machine->id)}}', '#tr-{{$vending_machine->id}}')" data-toggle="tooltip" data-original-title="Close">
                                                    <button class="btn btn-info btn-icon-anim btn-square  btn-sm"><i class="icon-trash"></i></button>                                                    
                                                </a>
                                                <a onclick="showDetail('{{url("stand/".$vending_machine->id."/slot")}}')" data-toggle="modal" data-target=".detail-modal" data-toggle="tooltip" data-toggle="tooltip" data-original-title="Detail">
                                                    <button class="btn btn-primary btn-icon-anim btn-square btn-sm"><i class="fa fa-eye"></i></button>
                                                </a>
                                                <a onclick="showDetail('{{url("stand/".$vending_machine->id."/stock")}}')" data-toggle="modal" data-target=".detail-modal" data-toggle="tooltip" data-toggle="tooltip" data-original-title="Detail">
