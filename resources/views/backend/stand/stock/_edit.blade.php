    ...
    <div class="modal-content">
        ...
        <div class="col-lg-12" id="form-item">
            <form id="form-item-maintenance-activity">
                {!! csrf_field() !!}
                <input type="hidden" id="vending_machine_stock_id" name="vending_machine_stock_id" value="{{$vending_machine_stock->id}}">
                ...
                <div class="form-group mt-20 ">
                    ...
                    <input type='text' name="name" id="name" required class="form-control" value="{{$vending_machine_stock->name}}" />
                </div>
                <div class="form-group mt-20 ">
                    <label class="control-label mb-10">{!! label('alias', 'alias') !!}</label>
                    <input type='text' name="alias" id="alias" required class="form-control" value="{{$vending_machine_stock->alias}}"/>
                </div>
                <div class="form-group mt-20 ">
                    <label class="control-label mb-10">{!! label('makanan', 'food name') !!}</label>
                    <input type='text' name="food_name" id="food_name" required class="form-control" value="{{$vending_machine_stock->food_name}}"/>
                </div>
                <div class="form-group mt-20 ">
                    <label class="control-label mb-10">{!! label('keuntungan platform', 'profit platform') !!}</label>
                    <input type='text' name="profit_platform" id="profit_platform" required class="form-control format-price" value="{{$vending_machine_stock->profit_platform}}" />
                </div>
                <div class="form-group mt-20 ">
                    <div class="form-group">
                        <label class="control-label mb-10">{!! label('tanggal exp', 'expired date') !!}</label>
                        <div class='input-group date' id='datetimepicker1'>
                            <input type='text' name="expired_date" value="{{date('m-d-Y a', strtotime($vending_machine_stock->expired_date))}}" class="form-control" />
