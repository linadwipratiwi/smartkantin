<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <a class="btn btn-info btn-sm btn-lable-wrap left-label pull-right" href="{{url("stand/".$vending_machine->id."/stock/export")}}"> <span class="btn-label"><i class="fa fa-file-text"></i> </span><span class="btn-text">Download Laporan</span></a>
        </div>
        <div class="col-lg-12">
                    ...
                    <div id="team">
                        <table class="table color-table info-table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Slot Stand</th>
                            ...
                            @foreach($vending_machine->stocks as $i => $stock)
                                <tr id="tr-stock-{{$stock->id}}">
                                    <td class="">{{++$i}}</td>
                                    {{-- <td>
                                        <a  onclick="showDetail('{{url("stand/".$vending_machine->id."/stock/".$stock->id."/edit")}}')"data-toggle="tooltip" data-original-title="Edit">
                                            <button class="btn btn-default btn-icon-anim btn-square btn-sm"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a onclick="secureDelete('{{url('stand/".$vending_machine->id."/stock/'.$stock->id)}}', '#tr-stock-{{$stock->id}}')" data-toggle="tooltip" data-original-title="Delete"> 
