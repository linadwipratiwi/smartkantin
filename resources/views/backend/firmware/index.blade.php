                ...
                <div class="panel-heading">
                    <div class="pull-left">
                        <div class="dt-buttons">
                            <a class="dt-button buttons-copy buttons-html5" tabindex="0" aria-controls="example" href="{{url('firmware/create')}}"><i class="fa fa-plus"></i> <span>Buat baru</span></a>
                        </div>
                        ...
                        <div class="table-wrap">
                            <div class="table-responsive">
                                <table id="datatable" class="table table-hover display  pb-30" >
                                    ...
                                    <tbody>
                                        @foreach($firmwares as $row => $firmware)
                                        <tr id="tr-{{$firmware->id}}">
                                            <td>{{$row + 1}}</td>
                                            <td>{{$firmware->name}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="secureDelete('{{url('firmware/'.$firmware->id)}}', '#tr-{{$firmware->id}}')" data-toggle="tooltip" data-original-title="Close">
