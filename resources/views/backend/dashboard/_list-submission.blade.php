    ...
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <h6 class="panel-title txt-dark">Daftar Pengajuan Alat Butuh Approval</h6>
            </div>
            <div class="panel-wrapper collapse in">
                <div class="panel-body">
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr-{{$submission->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a onclick="reject('{{url('reject')}}', 'Submission', {{$submission->id}}, {{$submission->approval_to_oh}}, 'status_approval_to_oh', 'notes_approval_to_oh', 'approval_at_oh', '{{url('/')}}')" data-toggle="modal" data-target=".detail-modal" data-toggle="tooltip" data-original-title="Close">
                                            ...
                                            <a onclick="reject('{{url('reject')}}', 'Submission', {{$submission->id}}, {{$submission->approval_to_spv_epm}}, 'status_approval_to_spv_epm', 'notes_approval_to_spv_epm', 'approval_at_spv_epm', '{{url('/')}}')" data-toggle="modal" data-target=".detail-modal" data-toggle="tooltip" data-original-title="Close">
                                                <button class="btn btn-danger btn-icon-anim btn-square  btn-sm"><i class="icon-close"></i></button>                                                    
                                            </a>
                                            @endif
                                        </td>
                    ...
                    @else
                    TIDAK ADA PENGAJUAN ALAT YANG BUTUH PERSETUJUAN ANDA
                    @endif
                </div>
            </div>
        </div>	
