                    ...
                    <table id="datatable" class="table table-hover display  pb-30">
                        ...
                        <tbody>
                            ...
                            <tr id="tr-{{$client->id}}">
                                <td>{{$row + 1}}</td>
                                <td>{{$client->name}}</td>
                                <td><label id = "share<?php echo $client->id;?>" > {{$client->share}}</label>  </td>
                                <td>
                                    
                                    <button class="btn btn-default btn-icon-anim btn-square btn-sm"><i class="fa fa-pencil" onclick="addShareOwner({{$client->id}})"></i></button>
                                    
                                    <button class="btn btn-default btn-icon-anim btn-square btn-sm"><i class="fa fa-pencil" onclick="reduceShareOwner({{$client->id}})"></i></button>
                    ...
                    <div class="form-wrap">
                        <form method="post" action="{{url('client/'.$client->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="control-label mb-10 text-left">{!! label('jeneng', 'name') !!}</label>
...
<script>
    ...
    function addShareOwner(value) { 
            data="share"+value;
            
            console.log(data); 
            count=document.getElementById(data).textContent;
            number= Number(count);
            console.log(number);   
        ...
        function reduceShareOwner(value) { 
            data="share"+value;
