...
class VendingMachineSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
            [
                'name' => 'Vending Machine V1 2019', 'alias' => 'vm_ydfs_01', 'production_year' => '2019', 'client_id' => 1, 'location' => 'Lokasi 1', 'ip' => '127.0.0.1', 'version_firmware_id' => 1, 'version_ui_id' => 2
            ]
        );
    ...
    public static function vendingMachineSlot()
    {
        $data = array(
            [
                ...
                'profit_client' => '2000',
                'profit_platform_type' => 'value',
                'profit_platform_percent' => 0,
                'profit_platform_value' => '3000',
